...
class DiaryRoomServiceTest {
    ...
    void getDiaryRooms(){
        ...
        //when
        List<DiaryRoomDTO> diaryRooms = diaryRoomService.getDiaryRooms(savedMember.getId(), null);
    ...
    void getDiaryNextPageRooms(){
        ...
        //when
        List<DiaryRoomDTO> diaryRooms = diaryRoomService.getDiaryRooms(savedMember.getId(), 6L);
